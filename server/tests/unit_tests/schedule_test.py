from project.logic.scheduling.elimination import get_number_of_rounds_to_create_single_elimination
from project.logic.scheduling.round_robin import get_number_of_rounds_to_create_round_robin
