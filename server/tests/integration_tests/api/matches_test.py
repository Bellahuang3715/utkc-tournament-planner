...
async def test_create_match(
    ...
    async with (
        ...
        inserted_team(
            DUMMY_TEAM2.model_copy(update={"tournament_id": auth_context.tournament.id, "club_id": auth_context.club.id})
        ) as team2_inserted,
    ):
        body = {
                ...
                "data": [
                    {
                        "stage_item_input1": {
                            ...
                            "team": {
                                ...
                                "updated": "2022-01-11T04:32:11Z",
                                "code": team1_inserted.code,
                                "club_id": team1_inserted.club_id,
                                "category_id": cat_mix.id,
                                "category": "Mixed",
                        ...
                        "stage_item_input2": {
                            ...
                            "team": {
                                "created": "2022-01-11T04:32:11Z",
                                "updated": "2022-01-11T04:32:11Z",
                                "code": team2_inserted.code,
                                "club_id": team2_inserted.club_id,
                                "category_id": cat_mix.id,
                                "category": "Mixed",
                                "category_color": "#d0ebff",
                                "club": auth_context.club.name,
